...
SizedBox myTextField(String label, TextEditingController controller, IconData? icon, double screenWidth,
  ...
  return SizedBox(
    ...
    child: TextField(
      ...
      decoration: InputDecoration(
          contentPadding: EdgeInsets.symmetric(vertical: screenWidth < 450 ? 20 : 15, horizontal: 12),
